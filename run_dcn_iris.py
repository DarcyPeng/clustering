...
if __name__ == "__main__":
    ...
    parser.add_argument('--sdae_fit_lr', type=float, default=0.1, metavar='N',
                        help='learning rate for training (default: 0.001)')
    parser.add_argument('--dcn_lr', type=float, default=0.1, metavar='N',
                        help='learning rate for training (default: 0.001)')
    ...
    for i in range(1, repeat+1):
        ...
        if True:
            ...
            dcn = DeepClusteringNetwork(input_dim=4, z_dim=2, n_centroids=3, binary=False,
                                        encodeLayer=[8], decodeLayer=[8], activation="relu",
                                        dropout=0,writer=writer,log_dir=log_dir,lambd=0.4)
            print(dcn)
