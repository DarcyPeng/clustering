...
if __name__ == "__main__":
    ...
    parser.add_argument('--sdae_lr', type=float, default=0.01, metavar='N',
                        help='learning rate for training (default: 0.001)')
    parser.add_argument('--dec_lr', type=float, default=0.0000001, metavar='N',
                        help='learning rate for training (default: 0.001)')
    ...
    train_path = 'D:\code\dec-pytorch\dataset\ecoli\ecoli.pkl'
    # log_dir = 'logs/dec-'+datasetname
    ...
    for i in range(1, repeat+1):
        ...
        if os.path.exists("model/dec-run-"+datasetname+"-%d.pt" % i)==False:
            ...
            dec = DEC(input_dim=7, z_dim=3, n_clusters=7,
                encodeLayer=[5], activation="relu", dropout=0, writer=writer,log_dir=log_dir)
            # print(dec)
