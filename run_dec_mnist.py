...
if __name__ == "__main__":
    ...
    parser.add_argument('--dec_lr', type=float, default=0.01, metavar='N',
                        help='learning rate for training (default: 0.001)')
    ...
    for i in range(1, repeat+1):
        ...
        if os.path.exists("model/dec-run-mnist-%d.pt" % i)==False:
            # finetune
            fit_train=None
            fit_test = None
            X=None
            ...
            dec.fit(train_loader, lr=args.dec_lr, batch_size=batch_size, num_epochs=100,
                update_interval=1)
            dec_savepath = ("model/dec-run-mnist-%d.pt" % i)
